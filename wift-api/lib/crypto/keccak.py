...
# Original codebase from https://github.com/ctz/keccak/blob/master/keccak.py
# String to byte conversions adapted to work on Python3
...
class KeccakState(object):
    ...
    def bytes2str(bb):
        ...
        """
        return b''.join(bytes([ch]) for ch in bb)
    ...
    def str2bytes(ss):
        ...
        """
        return [int(byte) for byte in ss]
